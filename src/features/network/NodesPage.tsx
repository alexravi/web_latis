...
const NodesPage: React.FC = () => {
    ...
    const incomingConsults = [
        ...
        { id: 2, name: "Dr. James Wilson", role: "Cardiologist", institution: "St. Mary's", mutual: 12 },
    ];
                                    ...
                                    {incomingConsults.map(req => (
                                        <div key={req.id} style={{
                                            ...
                                            <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                                                ...
                                                <div>
                                                    <div style={{ fontWeight: 600, fontSize: '1.05rem' }}>{req.name}</div>
                                                    <div style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem' }}>{req.role} • {req.institution}</div>
                                                    <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', marginTop: '4px' }}>
                                                        <span style={{ color: 'var(--color-accent)' }}>↗</span> {req.mutual} synaptic links
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div style={{ gridColumn: 'span 4' }}>
                            <div style={{
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexShrink: 0 }}>
                                    ...
                                    <span style={{ fontSize: '0.9rem', color: 'var(--color-text-muted)' }}>{myNodes.length} Nodes</span>
                                </div>
                                    ...
                                    {myNodes.map(node => (
                                        <div key={node.id} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            ...
                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                <div style={{ fontSize: '0.95rem', fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{node.name}</div>
                                                <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{node.role}</div>
                                            </div>
                                            <div style={{
