...
const MessagingPage: React.FC = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-gray-50 dark:bg-gray-900">
            <div className={`w-full md:w-1/3 lg:w-1/4 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 ${selectedConversationId ? 'hidden md:block' : 'block'}`}>
                <ConversationList
